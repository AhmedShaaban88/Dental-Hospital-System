...
const  helpTextFloor= $(".help:eq(2)");
const  helpTextSpecialization= $(".help:eq(3)");
...
const  helpTextMainEdit= $(".help:eq(4)");
const  helpTextSecEdit= $(".help:eq(5)");
const  helpTextFloorEdit= $(".help:eq(6)");
const  helpTextSpecializationEdit= $(".help:eq(7)");
