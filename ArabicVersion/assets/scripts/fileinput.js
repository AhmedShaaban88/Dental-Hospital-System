...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tCaption = '<div class="file-caption form-control {class}" tabindex="500">\n' +
                ...
                '  <input class="file-caption-name border-0" onkeydown="return false;" onpaste="return false;">\n' +
                '</div>';
            //noinspection HtmlUnknownAttribute
            ...
            tFooter = '<div class="file-thumbnail-footer">\n' +
                '    <div class="file-footer-caption row" title="{caption}">\n' +
                '        <div class="file-size-info col-sm-6">{size}</div>\n' +
                '        <div class="file-caption-info col-sm-6">{caption}</div>\n' +
    ...
    $.fn.fileinputLocales.en = {
        ...
        removeLabel: 'حذف',
        removeTitle: 'حذف الملفات',
        uploadLabel: 'رفع الملفات',
        uploadTitle: 'رفع الملفات',
        msgNo: 'No',
        msgNoFilesSelected: 'اختر الملفات',
        msgCancelled: 'Cancelled',
        msgPlaceholder: 'اختر الملفات',
        msgZoomModalHeading: 'Detailed Preview',
        msgFileRequired: 'You must select a file to upload.',
        msgSizeTooSmall: 'File "{name}" (<b>{size} KB</b>) is too small and must be larger than <b>{minSize} KB</b>.',
        msgSizeTooLarge: 'تعدي الملف "{name}" اكبر حد مسموح به لحجم الصوره(<b>{maxSize} MB</b>)',
        msgFilesTooLess: 'You must select at least <b>{n}</b> {files} to upload.',
        msgFilesTooMany: 'Number of files selected for upload <b>({n})</b> exceeds maximum allowed limit of <b>{m}</b>.',
        msgFileNotFound: 'File "{name}" not found!',
        msgFileSecured: 'لا يمكن قراءه الملف "{name}"',
        msgFileNotReadable: 'لا يمكن قراءه الملف "{name}"',
        msgFilePreviewAborted: 'File preview aborted for "{name}".',
        msgFilePreviewError: 'حدث خطأ اثناء قراءه الملف "{name}"',
        msgInvalidFileName: 'لا يمكن قراءه الملف "{name}"',
        msgInvalidFileType: 'نوع الملف "{name}" غير مسموح',
        msgInvalidFileExtension:'صيغه الملف "{name}" غير مسوحه فقط الصيغ "{extensions}" مدعومه',
        msgFileTypes: {
            'image': 'image',
            'html': 'HTML',
            'text': 'text',
        ...
        msgUploadAborted: 'تم الغاء الرفع',
        msgUploadThreshold: 'جاري الرفع',
        msgUploadBegin: 'بدء الرفع',
        msgUploadEnd: 'تم',
        msgUploadEmpty: 'الملفات الموجوده حاليا غير صالحه لرفعها',
        msgUploadError: 'خطأ',
        msgValidationError: 'خطأ',
        msgLoading: 'Loading file {index} of {files} &hellip;',
        msgProgress: 'Loading file {index} of {files} - {name} - {percent}% completed.',
        msgSelected: '{n} {files} مختاره',
        ...
        msgAjaxError: 'حدث خطأ اعد المحاوله في وقت لاحق !',
        msgAjaxProgressError: '{operation} فشل',
        ajaxOperations: {
            deleteThumb: 'مسح الملف',
            uploadThumb: 'رفع الملف',
            uploadBatch: 'batch file upload',
            uploadExtra: 'form data upload'
        },
        dropZoneTitle: 'اسحب الملفات الي هنا او اضغط علي اختر &hellip;',
        dropZoneClickTitle: '<br>(or click to select {files})',
        previewZoomButtonTitles: {
            prev: 'التالي',
            next: 'السابق',
            toggleheader: 'اخفاء الاسم',
            fullscreen: 'ملئ الشاشه',
            borderless: 'عرض بالجوانب',
            close: 'اغلاق'
        },
