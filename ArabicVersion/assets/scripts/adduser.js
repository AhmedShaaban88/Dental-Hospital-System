...
const anotherEmpModal = $("#copy-emp-modal");
const anotherRoleModal = $("#copy-role-modal");
...
$(".check-tab").on("click",function (e) {
    // if($(".copyModal").hasClass("in")){
    //     var openModal = $(this).parent().attr("href");
    //     var tabModal = $(`[href=${openModal}]`).eq(0).find(".check-tab");
    //     const spanCheckedMain = tabModal.find("span:first-child");
    //     const inputCheckedMain = tabModal.find("input");
    //     spanCheckedMain.removeClass("indeterminate");
    //     if(!inputCheckedMain.prop("checked")){
    //         spanCheckedMain.addClass("checked");
    //         inputCheckedMain.prop("checked", true);
    //     }else{
    //         spanCheckedMain.removeClass("checked");
    //         inputCheckedMain.prop("checked", false);
    //     }
    // }
...
userName.on("input",function () {
    if($(this).val() === ''){
       //userNameHelp.html("<i class=\"icon-cancel-circle2\"></i> اسم المستخدم مستخدم مسبقا");
       //userNameHelp.html("<i class=\"icon-cancel-circle2\"></i> اسم المستخدم مطلوب");
        userNameHelp.removeClass("hidden");
    }else{
        userNameHelp.removeClass("hidden").addClass("help-true").html("<i class=\"icon-checkmark-circle\"></i> اسم المستخدم صحيح");
    }
});
empName.on("input",function () {
    if($(this).val() === ''){
       //empNameHelp.html("<i class=\"icon-cancel-circle2\"></i> اسم الموظف مستخدم مسبقا");
       //empNameHelp.html("<i class=\"icon-cancel-circle2\"></i> اسم الموظف مطلوب");
        empNameHelp.removeClass("hidden");
    }else{
        empNameHelp.removeClass("hidden").addClass("help-true").html("<i class=\"icon-checkmark-circle\"></i> اسم الموظف صحيح");
    }
});
...
anotherEmp.click(function () {
    anotherEmpModal.show();
    anotherRoleModal.hide();
...
anotherRole.click(function () {
    anotherEmpModal.hide();
    anotherRoleModal.show();
    if(currentActive2 === null){
        currentActive2 = 'role';
    }else{
